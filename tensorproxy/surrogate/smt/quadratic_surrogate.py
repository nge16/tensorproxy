...
class QuadraticSurrogate(SurrogateModel):
    """Суррогатная модель на основе множественной линейной регрессии
    (обертка SMT)."""

    def __init__(self, *args, **kwargs) -> None:
        super().__init__(*args, **kwargs)
        self._model = QP(print_prediction=False)  # , print_global=False)
